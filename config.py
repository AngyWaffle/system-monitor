...
disk_threshold = [{'device': '/dev/nvme0n1p3', 'threshold': 80}, {'device': '/dev/nvme0n1p2', 'threshold': 80}, {'device': '/dev/nvme0n1p1', 'threshold': 80}, {'device': '/dev/sda1', 'threshold': 80}, {'device': '/dev/sda2', 'threshold': 80}] # Disk thresholds for each partition
